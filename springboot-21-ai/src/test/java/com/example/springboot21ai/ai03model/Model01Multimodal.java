...
public class Model01Multimodal {
    ...
    @Autowired
    @Qualifier("glm_41v_9b_thinking")
    private ChatModel glm4ChatModel;
    @Autowired
    @Qualifier("qwen_omni_turbo")
    private ChatModel qwenOmniTurboChatModel;
    @Autowired
    @Qualifier("gpt_4o_audio_preview")
    private ChatModel gpt4oAudioPreviewChatModel;

    private Resource imageResource = new ClassPathResource("/img/multimodal.test.png");
    private Resource audioResource = new ClassPathResource("/audio/joke-eng.wav");
